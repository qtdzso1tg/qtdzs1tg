import { Album, Track, Playlist, Results } from './index';
/**
 ...
 * @returns {Results[]} <Results[]> if successful, `string` if failed
 */
export declare const downloadAlbum: (obj: Album, outputPath?: string, sync?: boolean, callback?: any) => Promise<Results[] | string>;
/**
 ...
 * @returns {Results[]} <Results[]> if successful, `string` if failed
 */
export declare const downloadPlaylist: (obj: Playlist, outputPath?: string, callback?: any) => Promise<Results[] | string>;
/**
